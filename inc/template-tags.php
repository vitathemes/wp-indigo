...
if ( ! function_exists( 'wp_indigo_get_custom_category' ) ) :
	...
	function wp_indigo_get_custom_category(
		$wp_indigo_seprator = " ",
		$wp_indigo_custom_class = "c-post__cat",
		$wp_indigo_is_limited = false
	) {
		...
		if ( ! empty( get_the_category() ) ) {
			...
			if ( ! empty( $categories ) ) {
				...
				foreach ( $categories as $category ) {
					...
					$output .= '<a class="' . esc_attr( $wp_indigo_custom_class ) . '" href="' . esc_url( get_category_link( $category->term_id ) ) . '" alt="' . esc_attr( sprintf( __( 'View all posts in %s',
							'wp-indigo' ),
							$category->name ) ) . '">' . esc_html( $category->name ) . '</a>' . esc_html( $separator );
				}
...
if ( ! function_exists( 'wp_indigo_share_links' ) ) {
	...
	function wp_indigo_share_links( $wp_indigo_share_title = true ) {
		if ( get_theme_mod( 'show_share_icons', true ) ) {
			...
			echo sprintf( '<a class="c-social-share__item" target="_blank" href="%s"><span class="dashicons dashicons-facebook-alt c-social-share__item__icon"></span></a>',
				esc_url( $wp_indigo_facebook_url ) );
			echo sprintf( '<a class="c-social-share__item" target="_blank" href="%s"><span class="dashicons dashicons-twitter c-social-share__item__icon"></span></a>',
				esc_url( $wp_indigo_twitter_url ) );
			echo sprintf( '<a class="c-social-share__item" target="_blank" href="%s"><span class="dashicons dashicons-linkedin c-social-share__item__icon"></span></a>',
				esc_url( $wp_indigo_linkedin_url ) );
			echo '</div>';
...
if ( ! function_exists( 'wp_indigo_socials_links' ) ) :
	...
	function wp_indigo_socials_links() {
		...
		$wp_indigo_social_variables = array(
			$wp_indigo_facebook,
			$wp_indigo_twitter,
			$wp_indigo_instagram,
			$wp_indigo_linkedin,
		...
		if ( $wp_indigo_social_variable_flag === 1 ) {
			...
			if ( $wp_indigo_facebook ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="dashicons dashicons-facebook-alt"></span></a>',
					esc_url( $wp_indigo_facebook ),
					esc_html__( 'Facebook', 'wp-indigo' ) );
			}

			if ( $wp_indigo_twitter ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="dashicons dashicons-twitter"></span></a>',
					esc_url( $wp_indigo_twitter ),
					esc_html__( 'Twitter', 'wp-indigo' ) );
			}

			if ( $wp_indigo_instagram ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="dashicons dashicons-instagram"></span></a>',
					esc_url( $wp_indigo_instagram ),
					esc_html__( 'Instagram', 'wp-indigo' ) );
			}

			if ( $wp_indigo_linkedin ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="dashicons dashicons-linkedin"></span></a>',
					esc_url( $wp_indigo_linkedin ),
					esc_html__( 'Linkedin', 'wp-indigo' ) );
			}

			if ( $wp_indigo_github ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="ant-design:github-filled" data-inline="false"></span></a>',
					esc_url( $wp_indigo_github ),
					esc_html__( 'Github', 'wp-indigo' ) );
			}

			if ( $wp_indigo_mail ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="ant-design:mail-outlined" data-inline="false"></span></a>',
					esc_url( $wp_indigo_mail ),
					esc_html__( 'Mail', 'wp-indigo' ) );
			}

			if ( $wp_indigo_pinterest ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="bx:bxl-pinterest" data-inline="false"></span></a>',
					esc_url( $wp_indigo_pinterest ),
					esc_html__( 'pinterest', 'wp-indigo' ) );
			}

			if ( $wp_indigo_youtube ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="akar-icons:youtube-fill" data-inline="false"></span></a>',
					esc_url( $wp_indigo_youtube ),
					esc_html__( 'youtube', 'wp-indigo' ) );
			}

			if ( $wp_indigo_spotify ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="bx:bxl-spotify" data-inline="false"></span></a>',
					esc_url( $wp_indigo_spotify ),
					esc_html__( 'spotify', 'wp-indigo' ) );
			}

			if ( $wp_indigo_lastfm ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="brandico:lastfm-rect" data-inline="false"></span></a>',
					esc_url( $wp_indigo_lastfm ),
					esc_html__( 'lastfm', 'wp-indigo' ) );
			}

			if ( $wp_indigo_gitlab ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="ion:logo-gitlab" data-inline="false"></span></a>',
					esc_url( $wp_indigo_gitlab ),
					esc_html__( 'gitlab', 'wp-indigo' ) );
			}

			if ( $wp_indigo_stackoverflow ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="cib:stackoverflow" data-inline="false"></span></a>',
					esc_url( $wp_indigo_stackoverflow ),
					esc_html__( 'stackoverflow', 'wp-indigo' ) );
			}

			if ( $wp_indigo_reddit ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="akar-icons:reddit-fill" data-inline="false"></span></a>',
					esc_url( $wp_indigo_reddit ),
					esc_html__( 'reddit', 'wp-indigo' ) );
			}

			if ( $wp_indigo_quora ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="bx:bxl-quora" data-inline="false"></span></a>',
					esc_url( $wp_indigo_quora ),
					esc_html__( 'quora', 'wp-indigo' ) );
			}

			if ( $wp_indigo_medium ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="ant-design:medium-circle-filled" data-inline="false"></span></a>',
					esc_url( $wp_indigo_medium ),
					esc_html__( 'medium', 'wp-indigo' ) );
			}

			if ( $wp_indigo_vimeo ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="brandico:vimeo-rect" data-inline="false"></span></a>',
					esc_url( $wp_indigo_vimeo ),
					esc_html__( 'vimeo', 'wp-indigo' ) );
			}

			if ( $wp_indigo_dribbble ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="akar-icons:dribbble-fill" data-inline="false"></span></a>',
					esc_url( $wp_indigo_dribbble ),
					esc_html__( 'dribbble', 'wp-indigo' ) );
			}

			if ( $wp_indigo_behance ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="ant-design:behance-outlined" data-inline="false"></span></a>',
					esc_url( $wp_indigo_behance ),
					esc_html__( 'behance', 'wp-indigo' ) );
			}

			if ( $wp_indigo_lanyrd ) {
				echo sprintf( '<a href="%s" aria-label="%s" class="c-social-share__item" target="_blank"><span class="iconify" data-icon="cib:lanyrd" data-inline="false"></span></a>',
					esc_url( $wp_indigo_lanyrd ),
					esc_html__( 'lanyrd', 'wp-indigo' ) );
			}
...
if ( ! function_exists( 'wp_indigo_taxonomy_filter' ) ) :
	 ...
	 */
	function wp_indigo_taxonomy_filter(
		$wp_indigo_className = "",
		$wp_indigo_getSeparator = ", ",
		$wp_indigo_is_limited = false,
		$wp_indigo_taxonomy = "category",
		$wp_indigo_hard_limit = false
	) {
		...
		if ( ! empty( $taxonomies ) ) {
			...
			foreach ( $taxonomies as $category ) {
				...
				if ( $category->count != 0 ) {
					...
					$output .= '<a class="' . esc_attr( $wp_indigo_className ) . ' ' . esc_attr( $classactive ) . '" href="' . esc_url( site_url() . '/' . get_post_type() . '/?' . $wp_indigo_taxonomy . '=' . esc_html( $category->slug ) ) . '" alt="' . esc_attr( sprintf( __( 'View all posts in %s',
							'wp-indigo' ),
							$category->name ) ) . '">' . esc_html( $category->name ) . '</a>' . esc_html( $separator );
				}
			}
...
if ( ! function_exists( 'wp_indigo_get_taxonomy' ) ) :
	 ...
	 */
	function wp_indigo_get_taxonomy(
		$wp_indigo_taxonomy_name = "",
		$wp_indigo_class_name = "",
		$wp_indigo_tag_name = "span"
	) {
	...
	function wp_indigo_get_post_tags( $wp_indigo_class_name = "" ) {
		...
		if ( $wp_indigo_post_tags ) {
			foreach ( $wp_indigo_post_tags as $wp_indigo_post_tag ) {
				...
				echo sprintf( '<a class="%s" href="%s" aria-label="%s" >%s</a>',
					esc_attr( $wp_indigo_class_name ),
					esc_url( get_tag_link( $wp_indigo_post_tag->term_id ) ),
					esc_html( $wp_indigo_post_tag->name ),
					esc_html( $wp_indigo_post_tag->name ) );
...
if ( ! function_exists( 'wp_indigo_footer' ) ) :
	function wp_indigo_footer() {
		if ( get_theme_mod( 'footer_menu_pos', 'center' ) === 'top' ): ?>
            <div class="c-footer__menu s-footer-menu">
				<?php
        ...
        <div class="c-footer__copy">
            ...
            <a class="c-footer__link h5 u-link--secondary" href="<?php echo esc_url( get_theme_mod( 'copylink',
		...
		<?php if ( get_theme_mod( 'footer_menu_pos', 'center' ) === 'bottom' ): ?>
            <div class="c-footer__menu s-footer-menu">
				<?php
				if ( has_nav_menu( 'primary-footer' ) ) {
