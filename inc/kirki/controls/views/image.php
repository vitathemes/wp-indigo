...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'wp-indigo' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'wp-indigo' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'wp-indigo' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'wp-indigo' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'wp-indigo' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'wp-indigo' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'wp-indigo' ); ?>',
} );
#>
