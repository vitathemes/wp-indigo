...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'wp-indigo' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'wp-indigo' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'wp-indigo' ),
			'200'       => esc_html__( 'Light 200', 'wp-indigo' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'wp-indigo' ),
			'300'       => esc_html__( 'Book 300', 'wp-indigo' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'wp-indigo' ),
			'400'       => esc_html__( 'Normal 400', 'wp-indigo' ),
			'regular'   => esc_html__( 'Normal 400', 'wp-indigo' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'wp-indigo' ),
			'500'       => esc_html__( 'Medium 500', 'wp-indigo' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'wp-indigo' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'wp-indigo' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'wp-indigo' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'wp-indigo' ),
			'700'       => esc_html__( 'Bold 700', 'wp-indigo' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'wp-indigo' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'wp-indigo' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'wp-indigo' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'wp-indigo' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'wp-indigo' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'wp-indigo' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'wp-indigo' ),
		);
	}
