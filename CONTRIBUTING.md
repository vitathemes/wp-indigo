...
* Please **do not** use the issue tracker for personal support requests (use the contact form in
  [VitaThemes.com](https://vitathemes.com/) to ask for help, or if you want the VitaThemes Team to dedicate some time to your issue, we [offer our services](https://veronalabs.com/services/) as well).
