...
<header class="c-single__entry-header">
    ...
    <div class="c-single__entry-header__content">
		...
		if ( is_singular() ) :
			...
			the_title( '<h2 class="c-single__entry-title u-letter-space-medium"><a href="' . esc_url( get_permalink() ) . '" rel="bookmark">',
				'</a></h2>' );
		endif;
		?>

        <div class="c-single__cats s-single-cats">
        ...
        <div class="c-single__entry-meta">
			...
			if ( 'portfolios' == get_post_type() ) {
				wp_indigo_get_taxonomy( "portfolio_category",
					"c-single__cat c-single__cat--sep u-link--secondary h6",
					"a" );
			} else {
				?>
